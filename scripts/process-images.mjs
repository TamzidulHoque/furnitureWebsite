...
const MANIFEST = [
  ...
  { src: `${A}/747604772_1684144490383710_8069181014316575055_n.jpg`, out: 'living-royal',    crop: [0, 0.26, 1, 0.90] },
  { src: `${A}/761504076_1702070998591059_1878849163198993217_n.jpg`, out: 'living-floral',   crop: [0, 0.27, 1, 0.93] },
  { src: `${A}/768371614_1710462144418611_5698540196193769070_n.jpg`, out: 'sofa-grey-velvet',crop: [0, 0.27, 1, 0.94] },
  { src: `${A}/758501475_1695949819203177_8539249593337200471_n.jpg`, out: 'sofa-cream',      crop: [0, 0.27, 1, 0.94] },
  { src: `${A}/751349978_1688125409985618_7348280562578590906_n.jpg`, out: 'dining-cream',    crop: [0, 0.29, 1, 0.94] },
  { src: `${A}/761596606_1700154842116008_2266593655759211928_n.jpg`, out: 'dining-floral',   crop: [0, 0.29, 1, 0.93] },
  { src: `${A}/768205284_1711404377657721_1644144981235924073_n.jpg`, out: 'cabinet-gold',    crop: [0, 0.29, 1, 0.91] },
  { src: `${A}/772521594_1714467227351436_1245435330287886749_n.jpg`, out: 'chairs-studio',   crop: [0, 0.275, 1, 1], sat: 1 }, // configurator base: keep colors honest
  // ---------- NOIR cluster ----------
  { src: `${A}/768432878_1709553134509512_2759590473845537362_n.jpg`, out: 'console-noir',    crop: [0, 0.29, 1, 0.915] },
  { src: `${A}/773074508_1716547623810063_5708541284272618229_n.jpg`, out: 'dining-noir',     crop: [0, 0.27, 1, 0.91] },
